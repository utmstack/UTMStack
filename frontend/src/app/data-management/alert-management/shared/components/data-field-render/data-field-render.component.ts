...
import {
  ALERT_DESTINATION_FIELD,
  ALERT_DESTINATION_IP_FIELD,
  ALERT_NOTE_FIELD,
  ALERT_SEVERITY_FIELD,
  ALERT_SEVERITY_FIELD_LABEL, ALERT_SOURCE_FIELD,
...
export class DataFieldRenderComponent implements OnInit {
  ...
  ALERT_SOURCE_FIELD = ALERT_SOURCE_FIELD;
  ALERT_DESTINATION_FIELD = ALERT_DESTINATION_FIELD;
