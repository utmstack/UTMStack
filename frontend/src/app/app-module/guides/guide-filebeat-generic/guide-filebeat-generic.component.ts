...
export class GuideFilebeatGenericComponent implements OnInit {
  ...
  commandsActivate: FilebeatCommands[] = [
    {module: UtmModulesEnum.TRAEFIK, os: 'linux', command: 'cd /opt/utmstack_agent_service_linux_amd64/beats/filebeat/ && '
    ...
    {module: UtmModulesEnum.APACHE, os: 'linux', command: 'cd /opt/utmstack_agent_service_linux_amd64/beats/filebeat/ && ./filebeat modules enable apache',
      path: '/opt/utmstack_agent_service_linux_amd64/beats/filebeat/modules.d/', restartCmd: 'sudo systemctl restart UTMStackModulesLogsCollector'},
    ...
    {module: UtmModulesEnum.ELASTICSEARCH, os: 'linux', command: 'cd /opt/utmstack_agent_service_linux_amd64/beats/filebeat/ && '
    ...
    {module: UtmModulesEnum.HAPROXY, os: 'linux', command: 'cd /opt/utmstack_agent_service_linux_amd64/beats/filebeat/ && '
    ...
    {module: UtmModulesEnum.MONGODB, os: 'linux', command: 'cd /opt/utmstack_agent_service_linux_amd64/beats/filebeat/ && '
    ...
    {module: UtmModulesEnum.KIBANA, os: 'linux', command: 'cd /opt/utmstack_agent_service_linux_amd64/beats/filebeat/ && '
    ...
    {module: UtmModulesEnum.LOGSTASH, os: 'linux', command: 'cd /opt/utmstack_agent_service_linux_amd64/beats/filebeat/ && '
    ...
    {module: UtmModulesEnum.KAFKA, os: 'linux', command: 'cd /opt/utmstack_agent_service_linux_amd64/beats/filebeat/ && '
    ...
    {module: UtmModulesEnum.MYSQL, os: 'linux', command: 'cd /opt/utmstack_agent_service_linux_amd64/beats/filebeat/ && '
    ...
    {module: UtmModulesEnum.REDIS, os: 'linux', command: 'cd /opt/utmstack_agent_service_linux_amd64/beats/filebeat/ && '
    ...
    {module: UtmModulesEnum.POSTGRESQL, os: 'linux', command: 'cd /opt/utmstack_agent_service_linux_amd64/beats/filebeat/ && '
    ...
    {module: UtmModulesEnum.NGINX, os: 'linux', command: 'cd /opt/utmstack_agent_service_linux_amd64/beats/filebeat/ && '
    ...
    {module: UtmModulesEnum.AUDITD, os: 'linux', command: 'cd /opt/utmstack_agent_service_linux_amd64/beats/filebeat/ && '
        + './filebeat modules enable auditd',
      path: '/opt/utmstack_agent_service_linux_amd64/beats/filebeat/modules.d/', restartCmd: 'sudo systemctl restart UTMStackModulesLogsCollector'},

    {module: UtmModulesEnum.OSQUERY, os: 'linux', command: 'cd /opt/utmstack_agent_service_linux_amd64/beats/filebeat/ && '
    ...
    {module: UtmModulesEnum.NATS, os: 'linux', command: 'cd /opt/utmstack_agent_service_linux_amd64/beats/filebeat/ && '
