...
import {UsedByComponent} from '../../../../scanner/shared/components/used-by/used-by.component';
...
import {AdScheduleCreateComponent} from '../ad-schedule-create/ad-schedule-create.component';
import {AdScheduleDeleteComponent} from '../ad-schedule-delete/ad-schedule-delete.component';

@Component({
  selector: 'app-active-directory-schedule-list',
  templateUrl: './ad-schedule-list.component.html',
  styleUrls: ['./ad-schedule-list.component.scss']
})
export class AdScheduleListComponent implements OnInit {
  fields: SortByType[] = [
    {
      fieldName: 'Name',
      field: 'name'
  ...
  newSchedule() {
    const modal = this.modalService.open(AdScheduleCreateComponent, {centered: true});
  ...
  deleteSchedule(schedule: any) {
    const modal = this.modalService.open(AdScheduleDeleteComponent, {centered: true});
    modal.componentInstance.schedule = schedule;
