export const ALERT_ROUTE = '/data/alert/view';
export const FILE_ROUTE = '/data/file/view';
export const ALERT_DETAIL_ROUTE = '/data/alert/detail/';
export const LOG_ROUTE = '/discover/log-analyzer';
export const SCANNER_ROUTE = 'scanner';
/**
 * This constant is used to bypass request on navigation to avoid cancel by interceptor
 */
