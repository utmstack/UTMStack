...
import { ArrowLeft, ArrowRight, Flame, Loader2, X } from 'lucide-react'
    ...
    >
      <div
        className={cn(
          ...
          // Step 1 is just two fields — size it like the alerts page's own
          // incident modal. Step 2 needs room for a filterable alert table,
          // so it grows once the user gets there.
          step === 1 ? 'w-full max-w-md' : 'h-[80vh] w-[95vw] max-w-3xl',
        )}
      >
