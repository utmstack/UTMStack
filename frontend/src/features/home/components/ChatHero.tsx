...
export function ChatHero() {
  ...
  // scroll internally instead of eating the page.
  useEffect(() => {
      ...
      <div className="fixed bottom-5 left-1/2 z-30 w-[min(760px,calc(100vw-2rem))] -translate-x-1/2">
        <div className="relative rounded-xl border border-border bg-card p-3 shadow-lg shadow-black/10">
          <textarea
            ...
            className="max-h-[140px] w-full resize-none border-0 bg-transparent text-sm leading-5 text-foreground placeholder:text-muted-foreground focus:outline-none"
          />
