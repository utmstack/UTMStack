...
const ROOT = 'integrations.setup.collector.pfsense'
const PORT = '7017'

function PfSenseGuide({ module: _module }: { module: Integration }) {
...
registerCollector({
  getName: () => 'PFSENSE',
  matches: (n) => n.includes('pfsense'),
  sections: [],
  render: (m) => <PfSenseGuide module={m} />,
})
