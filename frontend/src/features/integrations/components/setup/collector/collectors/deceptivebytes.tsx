...
function DeceptiveBytesGuide({ module: _module }: { module: Integration }) {
...
registerCollector({
  getName: () => 'DECEPTIVE_BYTES',
  matches: (n) => n.includes('deceptive'),
  sections: [],
  render: (m) => <DeceptiveBytesGuide module={m} />,
})
