...
@Component
public class ModuleCisco implements IModule {
    private static final String CLASSNAME = "ModuleCisco";

    private final UtmModuleService moduleService;

    public ModuleCisco(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.CISCO);
        } catch (Exception e) {
