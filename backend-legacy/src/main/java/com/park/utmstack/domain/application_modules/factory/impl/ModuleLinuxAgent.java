...
@Component
public class ModuleLinuxAgent implements IModule {
    private static final String CLASSNAME = "ModuleLinuxAgent";

    private final UtmModuleService moduleService;

    public ModuleLinuxAgent(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.LINUX_AGENT);
        } catch (Exception e) {
