...
@Component
public class ModuleSyslog implements IModule {
    private static final String CLASSNAME = "ModuleWindowsFaa";

    private final UtmModuleService moduleService;

    public ModuleSyslog(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.SYSLOG);
        } catch (Exception e) {
