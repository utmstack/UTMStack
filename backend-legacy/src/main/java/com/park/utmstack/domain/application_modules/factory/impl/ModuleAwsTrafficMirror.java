...
@Component
public class ModuleAwsTrafficMirror implements IModule {
    private static final String CLASSNAME = "ModuleWindowsFaa";

    private final UtmModuleService moduleService;

    public ModuleAwsTrafficMirror(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.AWS_TRAFFIC_MIRROR);
        } catch (Exception e) {
    ...
    public ModuleName getName() {
        return ModuleName.AWS_TRAFFIC_MIRROR;
    }
}
