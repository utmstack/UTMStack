...
@Component
public class ModuleApache2 implements IModule {
    private static final String CLASSNAME = "ModuleApache2";

    private final UtmModuleService moduleService;

    public ModuleApache2(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.APACHE2);
        } catch (Exception e) {
