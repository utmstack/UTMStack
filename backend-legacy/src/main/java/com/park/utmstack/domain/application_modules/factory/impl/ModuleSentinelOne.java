...
@Component
public class ModuleSentinelOne implements IModule {
    private static final String CLASSNAME = "ModuleSentinelOne";

    private final UtmModuleService moduleService;

    public ModuleSentinelOne(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.SENTINEL_ONE);
        } catch (Exception e) {
    ...
    public ModuleName getName() {
        return ModuleName.SENTINEL_ONE;
    }
}
