...
@Component
public class ModuleKaspersky implements IModule {
    private static final String CLASSNAME = "ModuleKasperskySecurity";

    private final UtmModuleService moduleService;

    public ModuleKaspersky(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.KASPERSKY);
        } catch (Exception e) {
