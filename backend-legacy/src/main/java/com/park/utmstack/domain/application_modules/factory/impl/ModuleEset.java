...
@Component
public class ModuleEset implements IModule {
    private static final String CLASSNAME = "ModuleEsetProtect";

    private final UtmModuleService moduleService;

    public ModuleEset(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.ESET);
        } catch (Exception e) {
