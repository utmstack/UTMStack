...
public class ModuleCiscoSwitch implements IModule  {
    private static final String CLASSNAME = "ModuleCiscoSwitch";

    private final UtmModuleService moduleService;

    public ModuleCiscoSwitch(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.CISCO_SWITCH);
        } catch (Exception e) {
    ...
    public ModuleName getName() {
        return ModuleName.CISCO_SWITCH;
    }
}
