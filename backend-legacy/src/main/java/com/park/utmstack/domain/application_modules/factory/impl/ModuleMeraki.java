...
@Component
public class ModuleMeraki implements IModule {
    private static final String CLASSNAME = "ModuleMeraki";

    private final UtmModuleService moduleService;

    public ModuleMeraki(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.MERAKI);
        } catch (Exception e) {
