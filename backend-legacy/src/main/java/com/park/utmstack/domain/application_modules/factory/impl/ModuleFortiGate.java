...
@Component
public class ModuleFortiGate implements IModule {
    private static final String CLASSNAME = "ModuleFortiGate";

    private final UtmModuleService moduleService;

    public ModuleFortiGate(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.FORTIGATE);
        } catch (Exception e) {
