...
@Component
public class ModuleFortiWeb implements IModule {
    private static final String CLASSNAME = "ModuleFortiWeb";

    private final UtmModuleService moduleService;

    public ModuleFortiWeb(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.FORTIWEB);
        } catch (Exception e) {
