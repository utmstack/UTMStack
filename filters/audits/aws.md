# AWS normalization and rule review
...
1 filter configurations and 73 matching shipped rule files.
...
`plugins/alerts/testdata/filter-contracts/aws.json`. Apply that support before running `go test ./...` in `plugins/alerts`.
