# IBM AIX normalization and rule review

Fix grok field spelling and origin.host; validate IP/protocol values.
...
`plugins/alerts/testdata/filter-contracts/ibm-aix.json`. Apply that support before running `go test ./...` in `plugins/alerts`.
