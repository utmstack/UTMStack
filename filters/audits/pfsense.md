# pfSense normalization and rule review

Normalize policy outcomes and validate standard IP/protocol values.
...
`plugins/alerts/testdata/filter-contracts/pfsense.json`. Apply that support before running `go test ./...` in `plugins/alerts`.
