# Generic Syslog normalization and rule review
...
`plugins/alerts/testdata/filter-contracts/syslog.json`. Apply that support before running `go test ./...` in `plugins/alerts`.
