# Cisco Switch normalization and rule review

Normalize authentication/ARP outcomes and the syslog severity scale.
...
`plugins/alerts/testdata/filter-contracts/cisco-switch.json`. Apply that support before running `go test ./...` in `plugins/alerts`.
