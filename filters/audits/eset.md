# ESET normalization and rule review

Separate event type from actionResult and classify actual vendor outcomes.
...
`plugins/alerts/testdata/filter-contracts/eset.json`. Apply that support before running `go test ./...` in `plugins/alerts`.
