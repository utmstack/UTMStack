...
Once a UTMStack master server is installed, use admin as the user and the [Master's DB password] used during installation as the password for the default user login.
