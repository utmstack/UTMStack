...
import (
	...
	"github.com/utmstack/UTMStack/collectors/as400/models"
...
func RegisterCollector(cnf *config.Config, UTMKey string) error {
	...
	utils.Logger.Info("Registering UTMStack AS400 Collector with Agent Manager...")
	utils.Logger.Info("Collector Details: IP=%s, Hostname=%s, Version=%s, Module=%s",
		ip, osInfo.Hostname, version.Version, CollectorModule_AS_400.String())
	...
	utils.Logger.Info("UTMStack AS400 Collector registered successfully")
