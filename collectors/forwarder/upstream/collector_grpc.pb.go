...
const (
	...
	CollectorService_GetCollectorIntegrationState_FullMethodName = "/agent.CollectorService/GetCollectorIntegrationState"
)
...
type CollectorServiceClient interface {
	...
	GetCollectorIntegrationState(ctx context.Context, in *IntegrationStateRequest, opts ...grpc.CallOption) (*IntegrationStateResponse, error)
}
...
func (c *collectorServiceClient) GetCollectorIntegrationState(ctx context.Context, in *IntegrationStateRequest, opts ...grpc.CallOption) (*IntegrationStateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IntegrationStateResponse)
	err := c.cc.Invoke(ctx, CollectorService_GetCollectorIntegrationState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CollectorServiceServer interface {
	...
	GetCollectorIntegrationState(context.Context, *IntegrationStateRequest) (*IntegrationStateResponse, error)
...
func (UnimplementedCollectorServiceServer) RegisterCollector(context.Context, *RegisterRequest) (*AuthResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RegisterCollector not implemented")
}
func (UnimplementedCollectorServiceServer) DeleteCollector(context.Context, *DeleteRequest) (*AuthResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteCollector not implemented")
}
func (UnimplementedCollectorServiceServer) ListCollector(context.Context, *ListRequest) (*ListCollectorResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListCollector not implemented")
}
func (UnimplementedCollectorServiceServer) GetCollectorAuth(context.Context, *ConnectorAuthRequest) (*ConnectorAuthResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCollectorAuth not implemented")
}
func (UnimplementedCollectorServiceServer) CollectorStream(grpc.BidiStreamingServer[CollectorMessages, CollectorMessages]) error {
	return status.Error(codes.Unimplemented, "method CollectorStream not implemented")
}
func (UnimplementedCollectorServiceServer) GetCollectorConfig(context.Context, *ConfigRequest) (*CollectorConfig, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCollectorConfig not implemented")
}
func (UnimplementedCollectorServiceServer) SetCollectorConfig(context.Context, *CollectorConfig) (*ConfigKnowledge, error) {
	return nil, status.Error(codes.Unimplemented, "method SetCollectorConfig not implemented")
}
func (UnimplementedCollectorServiceServer) GetCollectorIntegrationState(context.Context, *IntegrationStateRequest) (*IntegrationStateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCollectorIntegrationState not implemented")
}
...
func _CollectorService_GetCollectorIntegrationState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IntegrationStateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CollectorServiceServer).GetCollectorIntegrationState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CollectorService_GetCollectorIntegrationState_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CollectorServiceServer).GetCollectorIntegrationState(ctx, req.(*IntegrationStateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CollectorService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetCollectorIntegrationState",
			Handler:    _CollectorService_GetCollectorIntegrationState_Handler,
		},
	},
