...
func (UnimplementedAgentServiceServer) GetAgentAuth(context.Context, *ConnectorAuthRequest) (*ConnectorAuthResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAgentAuth not implemented")
}
...
func (UnimplementedPanelServiceServer) GetConnectionKey(context.Context, *ConnectionKeyRequest) (*ConnectionKeyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetConnectionKey not implemented")
}
