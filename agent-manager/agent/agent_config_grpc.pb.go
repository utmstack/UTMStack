...
func (c *agentConfigServiceClient) GetAgentConfig(ctx context.Context, in *ListAgentsModulesRequest, opts ...grpc.CallOption) (*ListAgentsModulesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/agent.AgentConfigService/GetAgentConfig", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentConfigServiceClient) AgentModuleUpdateStream(ctx context.Context, opts ...grpc.CallOption) (AgentConfigService_AgentModuleUpdateStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &AgentConfigService_ServiceDesc.Streams[0], "/agent.AgentConfigService/AgentModuleUpdateStream", opts...)
	if err != nil {
		return nil, err
	}
...
func _AgentConfigService_GetAgentConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/agent.AgentConfigService/GetAgentConfig",
	}
