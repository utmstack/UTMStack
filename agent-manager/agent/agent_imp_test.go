...
// idStream is the smallest thing that satisfies
// AgentService_AgentStreamServer for identity-comparison tests.
type idStream struct{ id int }

func (idStream) Send(*BidirectionalStream) error     { return nil }
func (idStream) Recv() (*BidirectionalStream, error) { return nil, nil }
func (idStream) SetHeader(metadata.MD) error         { return nil }
func (idStream) SendHeader(metadata.MD) error        { return nil }
func (idStream) SetTrailer(metadata.MD)              {}
func (idStream) Context() context.Context            { return context.Background() }
func (idStream) SendMsg(any) error                   { return nil }
func (idStream) RecvMsg(any) error                   { return nil }
