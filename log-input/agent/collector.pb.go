...
type RegisterRequest struct {
	...
	// Same stance as an agent's, and the same reason for reporting it: so the
	// console can say so. What a collector refuses is configuration rather than
	// commands, because configuration is the only thing the server sends it.
	NoRemoteControl bool `protobuf:"varint,5,opt,name=no_remote_control,json=noRemoteControl,proto3" json:"no_remote_control,omitempty"`
...
func (x *RegisterRequest) GetNoRemoteControl() bool {
	if x != nil {
...
type Collector struct {
	...
	NoRemoteControl bool                   `protobuf:"varint,10,opt,name=no_remote_control,json=noRemoteControl,proto3" json:"no_remote_control,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *Collector) GetNoRemoteControl() bool {
	if x != nil {
		return x.NoRemoteControl
	}
	return false
...
const file_collector_proto_rawDesc = "" +
	"\n" +
	"\x0fcollector.proto\x12\x05agent\x1a\fcommon.proto\"\xb9\x01\n" +
	...
	"\tcollector\x18\x04 \x01(\x0e2\x16.agent.CollectorModuleR\tcollector\x12*\n" +
	"\x11no_remote_control\x18\x05 \x01(\bR\x0fnoRemoteControl\"S\n" +
	...
	"\rListCollector\x12\x12.agent.ListRequest\x1a\x1c.agent.ListCollectorResponse\"\x00\x12O\n" +
	"\x10GetCollectorAuth\x12\x1b.agent.ConnectorAuthRequest\x1a\x1c.agent.ConnectorAuthResponse\"\x00\x12K\n" +
