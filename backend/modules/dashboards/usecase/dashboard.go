...
func (u *dashboardUsecase) Create(ctx context.Context, d *domain.UtmDashboard, user string) (*domain.UtmDashboard, error) {
	if d.ID != 0 {
...
func (u *dashboardUsecase) Update(ctx context.Context, d *domain.UtmDashboard, user string) (*domain.UtmDashboard, error) {
	if d.ID == 0 {
	...
	d.UserCreated = existing.UserCreated
...
func (u *dashboardUsecase) GetByID(ctx context.Context, id uint64) (*domain.UtmDashboard, error) {
	return u.repo.FindByID(ctx, id)
}

func (u *dashboardUsecase) List(ctx context.Context, f dto.DashboardFilter) ([]domain.UtmDashboard, int64, error) {
