...
func (h *APIKeyHandler) Create(c *gin.Context) {
	...
	resp, err := h.usecase.Create(c.Request.Context(), c.GetUint64("user_id"), req)
...
func (h *APIKeyHandler) List(c *gin.Context) {
	...
	resp, err := h.usecase.List(c.Request.Context(), c.GetUint64("user_id"), q)
	if err != nil {
...
func (h *APIKeyHandler) Get(c *gin.Context) {
	...
	resp, err := h.usecase.Get(c.Request.Context(), c.GetUint64("user_id"), id)
	if err != nil {
		h.writeErr(c, err)
		return
	}
...
func (h *APIKeyHandler) Update(c *gin.Context) {
	...
	resp, err := h.usecase.Update(c.Request.Context(), c.GetUint64("user_id"), id, req)
	if err != nil {
		h.writeErr(c, err)
		return
	}
...
func (h *APIKeyHandler) Delete(c *gin.Context) {
	...
	err := h.usecase.Delete(c.Request.Context(), c.GetUint64("user_id"), id)
...
func (h *APIKeyHandler) Generate(c *gin.Context) {
	...
	key, err := h.usecase.Generate(c.Request.Context(), c.GetUint64("user_id"), id)
	if err != nil {
		h.writeErr(c, err)
		return
	}
