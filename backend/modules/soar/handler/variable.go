...
func (h *VariableHandler) List(c *gin.Context) {
	f := dto.VariableFilter{
		...
		Name:   queryString(c, "variableName"),
	}
...
//	@Failure     500 {object} map[string]string
//	@Router      /soar/variables/{id} [delete]
