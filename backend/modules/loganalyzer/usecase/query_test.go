...
func (s *stubRepo) FindByID(context.Context, uuid.UUID) (*domain.SavedQuery, error) {
...
var queryID = uuid.MustParse("3f0d5a2c-1111-4000-8000-000000000002")

func TestUpdateKeepsWhatTheRequestCannotCarry(t *testing.T) {
	created := time.Date(2026, 1, 2, 3, 4, 5, 0, time.UTC)
	repo := &stubRepo{existing: &domain.SavedQuery{
		ID:        queryID,
		TenantID:  uuid.MustParse("8f1c1b8e-0000-4000-8000-000000000001"),
	...
	incoming := &domain.SavedQuery{ID: queryID, Name: "after", Dataset: "logs"}
