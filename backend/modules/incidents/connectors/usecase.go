...
type IncidentUsecase interface {
	Create(ctx context.Context, req dto.CreateIncidentRequest) (*domain.UtmIncident, error)
	AddAlerts(ctx context.Context, req dto.AddAlertsRequest) (*domain.UtmIncident, error)
	ChangeStatus(ctx context.Context, req dto.ChangeStatusRequest) (*domain.UtmIncident, error)
...
type IncidentNoteUsecase interface {
	Create(ctx context.Context, req dto.CreateNoteRequest) (*domain.UtmIncidentNote, error)
