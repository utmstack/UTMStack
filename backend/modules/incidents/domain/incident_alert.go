...
type UtmIncidentAlert struct {
	...
	TenantID      uuid.UUID `gorm:"column:tenant_id;type:uuid;not null;index;uniqueIndex:idx_incident_alert_tenant_alert" json:"-"`
...
func (UtmIncidentAlert) TableName() string { return "incident_alert" }
