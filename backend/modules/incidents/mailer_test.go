...
func TestResolveRecipients(t *testing.T) {
	users := []iam_domain.User{
		{Email: "a@x.com", Status: iam_domain.UserStatusActive},
		{Email: "b@x.com", Status: iam_domain.UserStatusInactive}, // deactivated → dropped
		{Email: "", Status: iam_domain.UserStatusActive},          // no email → dropped
		{Email: "c@x.com", Status: iam_domain.UserStatusActive},
	}
