...
@Component
public class ModuleMacOsAgent implements IModule {
    private static final String CLASSNAME = "ModuleMacOsAgent";

    private final UtmModuleService moduleService;

    public ModuleMacOsAgent(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.MACOS_AGENT);
        } catch (Exception e) {
