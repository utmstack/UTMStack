...
@Component
public class ModulePfsense implements IModule {
    private static final String CLASSNAME = "ModulePfsense";

    private final UtmModuleService moduleService;

    public ModulePfsense(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.PFSENSE);
        } catch (Exception e) {
