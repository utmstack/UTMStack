...
@Component
public class ModuleTraefik implements IModule {
    private static final String CLASSNAME = "ModuleTraefik";
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.TRAEFIK);
        } catch (Exception e) {
