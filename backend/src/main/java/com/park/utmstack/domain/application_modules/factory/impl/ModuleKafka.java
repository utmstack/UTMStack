...
@Component
public class ModuleKafka implements IModule {
    private static final String CLASSNAME = "ModuleKafka";
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.KAFKA);
        } catch (Exception e) {
