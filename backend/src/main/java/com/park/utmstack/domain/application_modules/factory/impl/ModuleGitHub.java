...
@Component
public class ModuleGitHub implements IModule {
    private static final String CLASSNAME = "ModuleGitHub";

    private final UtmModuleService moduleService;

    public ModuleGitHub(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.GITHUB);
        } catch (Exception e) {
