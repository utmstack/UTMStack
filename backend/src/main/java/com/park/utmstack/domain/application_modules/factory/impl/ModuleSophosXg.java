...
@Component
public class ModuleSophosXg implements IModule {
    private static final String CLASSNAME = "ModuleSophosXg";

    private final UtmModuleService moduleService;

    public ModuleSophosXg(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.SOPHOS_XG);
        } catch (Exception e) {
