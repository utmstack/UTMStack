...
@Component
public class ModuleIIS implements IModule {
    private static final String CLASSNAME = "ModuleIIS";
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.IIS);
        } catch (Exception e) {
