...
@Component
public class ModuleElasticsearch implements IModule {
    private static final String CLASSNAME = "ModuleElasticsearch";
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.ELASTICSEARCH);
        } catch (Exception e) {
    ...
    public ModuleName getName() {
        return ModuleName.ELASTICSEARCH;
    }
}
