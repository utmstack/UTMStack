...
@Component
public class ModuleVMWare implements IModule {
    private static final String CLASSNAME = "ModuleWindowsFaa";

    private final UtmModuleService moduleService;

    public ModuleVMWare(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.VMWARE);
        } catch (Exception e) {
