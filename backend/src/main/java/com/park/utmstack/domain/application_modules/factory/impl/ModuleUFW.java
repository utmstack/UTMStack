...
@Component
public class ModuleUFW implements IModule {

    private static final String CLASSNAME = "ModuleUFW";

    private final UtmModuleService moduleService;

    public ModuleUFW(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.UFW);
        } catch (Exception e) {
