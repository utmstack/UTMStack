...
@Component
public class ModuleSalesforce implements IModule {
    private static final String CLASSNAME = "ModuleSalesforce";

    private final UtmModuleService moduleService;

    public ModuleSalesforce(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.SALESFORCE);
        } catch (Exception e) {
