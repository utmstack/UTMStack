...
@Component
public class ModuleMikrotik implements IModule {
    private static final String CLASSNAME = "ModuleMikrotik";

    private final UtmModuleService moduleService;

    public ModuleMikrotik(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.MIKROTIK);
        } catch (Exception e) {
