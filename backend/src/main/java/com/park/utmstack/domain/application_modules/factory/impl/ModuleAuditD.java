...
@Component
public class ModuleAuditD implements IModule {
    private static final String CLASSNAME = "ModuleAuditD";
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.AUDITD);
        } catch (Exception e) {
