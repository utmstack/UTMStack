...
@Component
public class ModuleMacOS implements IModule {
    private static final String CLASSNAME = "ModuleMacOS";

    private final UtmModuleService moduleService;

    public ModuleMacOS(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.MACOS);
        } catch (Exception e) {
