...
@Component
public class ModuleLogstash implements IModule {
    private static final String CLASSNAME = "ModuleLogstash";
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.LOGSTASH);
        } catch (Exception e) {
