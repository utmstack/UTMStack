...
public enum ApplicationEventType {
    ...
    WARNING,
    INFO,
    INCIDENT_CREATION_ATTEMPT, INCIDENT_CREATION_SUCCESS, INCIDENT_ALERT_ADD_ATTEMPT, INCIDENT_ALERT_ADD_SUCCESS, INCIDENT_UPDATE_ATTEMPT, INCIDENT_UPDATE_SUCCESS, UNDEFINED
}
