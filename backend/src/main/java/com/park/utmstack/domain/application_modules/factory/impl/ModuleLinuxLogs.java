...
@Component
public class ModuleLinuxLogs implements IModule {
    private static final String CLASSNAME = "ModuleWindowsFaa";

    private final UtmModuleService moduleService;

    public ModuleLinuxLogs(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.LINUX_LOGS);
        } catch (Exception e) {
