...
@Component
public class ModulePaloAlto implements IModule {
    private static final String CLASSNAME = "ModulePaloAlto";

    private final UtmModuleService moduleService;

    public ModulePaloAlto(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.PALO_ALTO);
        } catch (Exception e) {
