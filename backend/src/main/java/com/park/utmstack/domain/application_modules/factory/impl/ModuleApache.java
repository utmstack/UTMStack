...
@Component
public class ModuleApache implements IModule {
    private static final String CLASSNAME = "ModuleApache";

    private final UtmModuleService moduleService;

    public ModuleApache(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.APACHE);
        } catch (Exception e) {
