...
@Component
public class ModuleOsQuery implements IModule {
    private static final String CLASSNAME = "ModuleOsQuery";
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.OSQUERY);
        } catch (Exception e) {
