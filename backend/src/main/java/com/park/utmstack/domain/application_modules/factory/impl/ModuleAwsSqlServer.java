...
@Component
public class ModuleAwsSqlServer implements IModule {
    private static final String CLASSNAME = "ModuleAwsIamUser";

    private final UtmModuleService moduleService;

    public ModuleAwsSqlServer(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.AWS_SQL_SERVER);
        } catch (Exception e) {
