...
public class ModuleSonicWall  implements IModule {
    private static final String CLASSNAME = "ModuleSonicWall";

    private final UtmModuleService moduleService;

    public ModuleSonicWall(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.SONIC_WALL);
        } catch (Exception e) {
