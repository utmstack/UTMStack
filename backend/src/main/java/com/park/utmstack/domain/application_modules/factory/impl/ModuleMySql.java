...
@Component
public class ModuleMySql implements IModule {
    private static final String CLASSNAME = "ModuleMySql";

    private final UtmModuleService moduleService;

    public ModuleMySql(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.MYSQL);
        } catch (Exception e) {
