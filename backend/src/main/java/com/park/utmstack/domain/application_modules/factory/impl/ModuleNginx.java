...
@Component
public class ModuleNginx implements IModule {
    private static final String CLASSNAME = "ModuleNginx";

    private final UtmModuleService moduleService;

    public ModuleNginx(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.NGINX);
        } catch (Exception e) {
