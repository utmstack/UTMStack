...
@Component
public class ModuleDeceptiveBytes implements IModule  {
    private static final String CLASSNAME = "ModuleDeceptiveBytes";

    private final UtmModuleService moduleService;

    public ModuleDeceptiveBytes(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.DECEPTIVE_BYTES);
        } catch (Exception e) {
