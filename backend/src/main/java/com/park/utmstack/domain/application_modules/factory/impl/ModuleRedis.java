...
@Component
public class ModuleRedis implements IModule {
    private static final String CLASSNAME = "ModuleRedis";
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.REDIS);
        } catch (Exception e) {
