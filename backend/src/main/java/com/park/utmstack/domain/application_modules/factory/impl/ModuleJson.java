...
@Component
public class ModuleJson implements IModule {
    private static final String CLASSNAME = "ModuleJson";

    private final UtmModuleService moduleService;

    public ModuleJson(UtmModuleService moduleService) {
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.JSON);
        } catch (Exception e) {
