...
@Component
public class ModuleHaProxy implements IModule {
    private static final String CLASSNAME = "ModuleHaProxy";
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.HAPROXY);
        } catch (Exception e) {
