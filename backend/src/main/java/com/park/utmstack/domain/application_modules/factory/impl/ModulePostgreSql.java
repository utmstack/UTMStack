...
@Component
public class ModulePostgreSql implements IModule {
    private static final String CLASSNAME = "ModulePostgreSql";
    ...
    public UtmModule getDetails(Long serverId) throws Exception {
        ...
        try {
            return moduleService.findByServerIdAndModuleName(serverId, ModuleName.POSTGRESQL);
        } catch (Exception e) {
