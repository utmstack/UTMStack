...
', '2026-02-23 16:15:14.566192', true, true, 'origin', null, '[]', '["adversary.ip","adversary.user"]');
...
', '2026-02-23 16:15:18.952423', true, true, 'origin', null, '[]', '["adversary.ip","adversary.user"]');
...
', '2026-02-23 16:15:19.969203', true, true, 'origin', null, '[]', '["adversary.ip","adversary.user"]');
...
', '2026-02-23 16:15:57.522165', true, true, 'origin', null, '[]', '["adversary.ip","adversary.user"]');
...
', '2026-02-23 16:16:03.392862', true, true, 'origin', null, '[]', '["adversary.ip","adversary.user"]');
...
', '2026-02-23 16:17:29.491501', true, true, 'origin', null, '[]', '["adversary.ip","adversary.user"]');
...
INSERT INTO public.utm_correlation_rules (id, rule_name, rule_confidentiality, rule_integrity, rule_availability, rule_category, rule_technique, rule_description, rule_references_def, rule_definition_def, rule_last_update, rule_active, system_owner, rule_adversary, rule_deduplicate_by_def, rule_after_events_def, rule_group_by_def) VALUES (1015, 'Windows: Multiple remote access login failures', 3, 2, 2, 'Credential Access', 'T1110 - Brute Force', 'Adversaries may use brute force techniques to gain access to accounts when passwords are unknown or when password hashes are obtained.', '["https://attack.mitre.org/techniques/T1110/"]', e'oneOf("log.eventCode", [20187, 20014, 20078, 20050, 20049, 2018]) &&
regexMatch("log.message", "(?i)(authentication failed|login failed|access denied|authentication error|invalid credentials)")
', '2026-02-23 16:17:42.344133', true, true, 'origin', null, '[{"indexPattern":"v11-log-wineventlog-*","with":[{"field":"origin.ip","operator":"filter_term","value":"{{origin.ip}}"}],"or":null,"within":"now-15m","count":10}]', '["adversary.ip","adversary.user"]');
...
', '2026-02-23 16:19:06.129872', true, true, 'origin', null, '[]', '["adversary.host","target.host"]');
...
', '2026-02-23 16:19:22.800322', true, true, 'origin', null, '[{"indexPattern":"v11-log-wineventlog-*","with":[{"field":"origin.host","operator":"filter_term","value":"{{origin.host}}"}],"or":null,"within":"now-10m","count":2}]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:23.774229', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:18:36.664953', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:18:37.849462', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:18:39.016715', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:18:41.336143', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:18:42.527359', true, true, 'origin', null, '[{"indexPattern":"v11-log-wineventlog-*","with":[{"field":"log.eventDataIpAddress","operator":"filter_term","value":"{{log.eventDataIpAddress}}"}],"or":null,"within":"now-30m","count":3}]', '["lastEvent.log.eventDataIpAddress","target.host"]');
...
', '2026-02-23 16:18:43.714091', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:18:44.818132', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:18:45.831954', true, true, 'origin', null, '[]', '["lastEvent.log.eventDataProcessName","adversary.host"]');
...
', '2026-02-23 16:18:46.920824', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:18:49.103144', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:18:50.172615', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:18:51.276047', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:18:52.325125', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:18:54.463056', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:18:55.551668', true, true, 'origin', null, '[{"indexPattern":"v11-log-wineventlog-*","with":[{"field":"log.eventDataIpAddress","operator":"filter_term","value":"{{log.eventDataIpAddress}}"}],"or":null,"within":"now-15m","count":5}]', '["lastEvent.log.eventDataIpAddress","adversary.host"]');
...
equals("log.channel", "Security")
', '2026-02-23 16:18:56.694349', true, true, 'origin', null, '[]', '["adversary.user","target.host","target.user"]');
...
', '2026-02-23 16:18:57.869062', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
!regexMatch("log.eventDataSubjectUserName", "(?i)^(SYSTEM|LOCAL SERVICE|NETWORK SERVICE)$")
', '2026-02-23 16:18:59.041587', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:00.316495', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:01.465752', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:02.639948', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:03.780715', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:09.561590', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:10.693974', true, true, 'origin', null, '[{"indexPattern":"v11-log-wineventlog-*","with":[{"field":"log.eventDataIpAddress","operator":"filter_term","value":"{{log.eventDataIpAddress}}"}],"or":null,"within":"now-5m","count":3}]', '["lastEvent.log.eventDataIpAddress","adversary.host"]');
...
', '2026-02-23 16:19:11.792793', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:14.046987', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:15.221310', true, true, 'origin', null, '[{"indexPattern":"v11-log-wineventlog-*","with":[{"field":"origin.host","operator":"filter_term","value":"{{origin.host}}"}],"or":null,"within":"now-30m","count":2}]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:16.331532', true, true, 'origin', '["adversary.host","adversary.user"]', '[]', null);
...
', '2026-02-23 16:19:17.435809', true, true, 'origin', null, '[]', '["lastEvent.log.eventDataProcessId","adversary.host"]');
...
', '2026-02-23 16:19:18.532899', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:19.648137', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:20.709892', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:21.854705', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:35.038887', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:36.223267', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
!regexMatch("log.eventDataSubjectUserName", "(?i)\\\\$$")
', '2026-02-23 16:19:37.411333', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:38.636625', true, true, 'origin', '["adversary.host","adversary.user"]', '[]', null);
...
', '2026-02-23 16:19:24.740211', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:25.874536', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:26.931122', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:27.976258', true, true, 'origin', null, '[{"indexPattern":"v11-log-wineventlog-*","with":[{"field":"origin.host","operator":"filter_term","value":"{{origin.host}}"}],"or":null,"within":"now-15m","count":2}]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:29.093231', true, true, 'origin', null, '[{"indexPattern":"v11-log-wineventlog-*","with":[{"field":"log.eventDataIpAddress","operator":"filter_term","value":"{{log.eventDataIpAddress}}"}],"or":null,"within":"now-15m","count":3}]', '["lastEvent.log.eventDataIpAddress","adversary.host"]');
...
', '2026-02-23 16:19:30.226586', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:31.386534', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:33.705324', true, true, 'origin', null, '[{"indexPattern":"v11-log-wineventlog-*","with":[{"field":"origin.host","operator":"filter_term","value":"{{origin.host}}"}],"or":null,"within":"now-30m","count":3}]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:45.775914', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
!regexMatch("target.user", "(?i)\\\\$$") &&
exists("target.user")
', '2026-02-23 16:19:55.865220', true, true, 'origin', null, '[{"indexPattern":"v11-log-wineventlog-*","with":[{"field":"log.eventDataIpAddress","operator":"filter_term","value":"{{log.eventDataIpAddress}}"}],"or":null,"within":"now-15m","count":3}]', '["lastEvent.log.eventDataIpAddress","adversary.host"]');
...
', '2026-02-23 16:19:56.893551', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:39.810138', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:40.983773', true, true, 'origin', null, '[{"indexPattern":"v11-log-wineventlog-*","with":[{"field":"log.eventDataSubjectUserName","operator":"filter_term","value":"{{log.eventDataSubjectUserName}}"}],"or":null,"within":"now-1h","count":1}]', '["adversary.host","adversary.user"]');
...
!contains("origin.host", "DC")
', '2026-02-23 16:19:42.186234', true, true, 'origin', null, '[{"indexPattern":"v11-log-wineventlog-*","with":[{"field":"origin.host","operator":"filter_term","value":"{{origin.host}}"}],"or":null,"within":"now-2h","count":2}]', '["lastEvent.log.eventDataSubjectUserName","adversary.host"]');
...
', '2026-02-23 16:19:44.557510', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
!regexMatch("log.eventDataSubjectUserName", "(?i)^(SYSTEM|TrustedInstaller)$")
', '2026-02-23 16:19:46.863971', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:47.995694', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:49.168845', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:50.309708', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:52.609140', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:53.756404', true, true, 'origin', '["adversary.host","lastEvent.log.eventDataSubjectUserName"]', '[{"indexPattern":"v11-log-wineventlog-*","with":[{"field":"origin.host","operator":"filter_term","value":"{{origin.host}}"}],"or":null,"within":"now-2h","count":10}]', null);
...
', '2026-02-23 16:19:54.877359', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:57.999926', true, true, 'origin', null, '[]', '["adversary.host","adversary.user"]');
...
', '2026-02-23 16:19:59.099681', true, true, 'origin', null, '[]', '["lastEvent.log.eventDataObjectName","lastEvent.log.eventDataSubjectUserName"]');
