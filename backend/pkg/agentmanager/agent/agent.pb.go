...
var file_agent_proto_goTypes = []any{
	...
	(*ListAgentsCommandsResponse)(nil), // 10: agent.ListAgentsCommandsResponse
	(*AgentCommand)(nil),               // 11: agent.AgentCommand
...
var file_agent_proto_depIdxs = []int32{
	...
	12, // 1: agent.Agent.status:type_name -> agent.Status
	...
	7,  // 4: agent.BidirectionalStream.heartbeat:type_name -> agent.Heartbeat
	13, // 5: agent.CommandResult.executed_at:type_name -> google.protobuf.Timestamp
	11, // 6: agent.ListAgentsCommandsResponse.rows:type_name -> agent.AgentCommand
	...
	8,  // 17: agent.PanelService.ProcessCommand:input_type -> agent.UtmCommand
	...
	10, // 26: agent.AgentService.ListAgentCommands:output_type -> agent.ListAgentsCommandsResponse
	9,  // 27: agent.PanelService.ProcessCommand:output_type -> agent.CommandResult
