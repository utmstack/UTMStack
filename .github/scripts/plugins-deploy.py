...
def main(environment):
	...
	plugin_bitdefender_blob.upload_from_filename(os.path.join(os.environ["GITHUB_WORKSPACE"], "plugins", "bitdefender", "com.utmstack.bitdefender.plugin"))	
	...
	pipeline_analysis_blob.upload_from_filename(os.path.join(os.environ["GITHUB_WORKSPACE"], "pipelines", "system_plugins_analysis.yaml"))
	pipeline_correlation_blob.upload_from_filename(os.path.join(os.environ["GITHUB_WORKSPACE"], "pipelines", "system_plugins_correlation.yaml"))
	pipeline_input_blob.upload_from_filename(os.path.join(os.environ["GITHUB_WORKSPACE"], "pipelines", "system_plugins_input.yaml"))
	pipeline_notification_blob.upload_from_filename(os.path.join(os.environ["GITHUB_WORKSPACE"], "pipelines", "system_plugins_notification.yaml"))
