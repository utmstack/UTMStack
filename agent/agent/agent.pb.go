...
var file_agent_proto_goTypes = []any{
	...
	(*Heartbeat)(nil),                  // 5: agent.Heartbeat
	(*UtmCommand)(nil),                 // 6: agent.UtmCommand
	(*CommandResult)(nil),              // 7: agent.CommandResult
	(*ListAgentsCommandsResponse)(nil), // 8: agent.ListAgentsCommandsResponse
	(*AgentCommand)(nil),               // 9: agent.AgentCommand
	(Status)(0),                        // 10: agent.Status
	(*timestamppb.Timestamp)(nil),      // 11: google.protobuf.Timestamp
	(*DeleteRequest)(nil),              // 12: agent.DeleteRequest
...
var file_agent_proto_depIdxs = []int32{
	...
	10, // 1: agent.Agent.status:type_name -> agent.Status
	6,  // 2: agent.BidirectionalStream.command:type_name -> agent.UtmCommand
	7,  // 3: agent.BidirectionalStream.result:type_name -> agent.CommandResult
	5,  // 4: agent.BidirectionalStream.heartbeat:type_name -> agent.Heartbeat
	11, // 5: agent.CommandResult.executed_at:type_name -> google.protobuf.Timestamp
	9,  // 6: agent.ListAgentsCommandsResponse.rows:type_name -> agent.AgentCommand
	11, // 7: agent.AgentCommand.created_at:type_name -> google.protobuf.Timestamp
	11, // 8: agent.AgentCommand.updated_at:type_name -> google.protobuf.Timestamp
	...
	1,  // 11: agent.AgentService.UpdateAgent:input_type -> agent.AgentRequest
	12, // 12: agent.AgentService.DeleteAgent:input_type -> agent.DeleteRequest
	13, // 13: agent.AgentService.ListAgents:input_type -> agent.ListRequest
	4,  // 14: agent.AgentService.AgentStream:input_type -> agent.BidirectionalStream
	13, // 15: agent.AgentService.ListAgentCommands:input_type -> agent.ListRequest
	6,  // 16: agent.PanelService.ProcessCommand:input_type -> agent.UtmCommand
	14, // 17: agent.AgentService.RegisterAgent:output_type -> agent.AuthResponse
	14, // 18: agent.AgentService.UpdateAgent:output_type -> agent.AuthResponse
	14, // 19: agent.AgentService.DeleteAgent:output_type -> agent.AuthResponse
	2,  // 20: agent.AgentService.ListAgents:output_type -> agent.ListAgentsResponse
	4,  // 21: agent.AgentService.AgentStream:output_type -> agent.BidirectionalStream
	8,  // 22: agent.AgentService.ListAgentCommands:output_type -> agent.ListAgentsCommandsResponse
	7,  // 23: agent.PanelService.ProcessCommand:output_type -> agent.CommandResult
